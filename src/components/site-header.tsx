    ...
    <div className="sticky top-0 z-40 border-b border-careblue-500/25 bg-graphite-950 text-offwhite">
      ...
      <header className="container-page flex h-16 items-center justify-between gap-4">
        ...
        >
          ...
          {itemCount > 0 && (
            <span className="absolute right-0 top-1 flex h-5 min-w-[20px] items-center justify-center rounded-full bg-violet-500 px-1 text-[11px] font-bold text-offwhite">
              {itemCount}
            </span>
          )}
        </button>
